...
class EagerJobScheduler(BaseJobScheduler):
    ...
    def schedule_job(self, job_name: str, job_id: str, input_model: BaseModel):
        ...
        asyncio.create_task(self.run_job_async(job_name, job_id, input_model_json))
        return job_id

    async def run_job_async(self, job_name: str, job_id: str, input_model_json: str):
        await self.runner.run_job(job_name, job_id, input_model_json)
